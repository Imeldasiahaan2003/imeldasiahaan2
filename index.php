...
<body>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="text-center fw-bold text-uppercase">Data Mahasiswa UMI</h3>
                <hr>
            </div>
        </div>
        <div class="row my-2">
            <div class="col-md">
                ...
                <a href="export.php" target="_blank" class="btn btn-success ms-1"><i class="bi bi-file-earmark-spreadsheet-fill"></i>&nbsp;Cetak Data</a>
            </div>
        </div>
        <div class="row my-3">
            <div class="col-md">
